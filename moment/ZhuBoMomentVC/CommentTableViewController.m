...
//    [self.view addSubview:contentTBV];
    ...
    arr = @[@"1\n2\n3\n4\n5\n6", @"1\n2\n3\n4\n5\n61\n2\n3\n4\n5\n61\n2\n3\n4\n5\n6国务卿由总统任命（经参议院同意），并对总统负责，是仅次于正、副总统的高级行政官员；是总统外交事务的主要顾问，内阁会议和国家安全委员会的首席委员。国务院设有副国务卿、。国务卿由总统任命（经参议院同意），并对总统负责，是仅次于正、副总统的高级行政官员；是总统外交事务的主要顾问，内阁会议和国家安全委员会的首席委员。国务院设有副国务卿、。", @"1\n2", @"1\n2\n3", @"国务卿由总统任命（经参议院同意），并对总统负责，是仅次于正、副总统的高级行政官员；是总统外交事务的主要顾问，内阁会议和国家安全委员会的首席委员。国务院设有副国务卿、。国务卿由总统任命（经参议院同意），并对总统负责，是仅次于正、副总统的高级行政官员；是总统外交事务的主要顾问，内阁会议和国家安全委员会的首席委员。国务院设有副国务卿、。",@"dddd"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        UserCell.content.text =arr[indexPath.row];
        return UserCell;
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0 ) {
        ...
        NSArray *nibArray = [[NSBundle mainBundle] loadNibNamed:@"ZhuBoMomentCell" owner:self options:nil];
        cell = (UserCommentCell *)[nibArray objectAtIndex:1];
        NSString *str = arr[indexPath.row];
        cell.content.text = str;
        CGSize s = [str calculateSize:CGSizeMake(cell.content.frame.size.width, FLT_MAX) font:[UIFont fontWithName:@"Arial-BoldItalicMT" size:14]];
